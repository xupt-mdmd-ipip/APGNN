...
def fcanet34(num_classes=16, pretrained=False):
...
if __name__ == '__main__':
    ...
    input = torch.randn(64, 30, 15, 15)
    # se = SEAttention(channel=30, reduction=8)
    c2wh = dict([(64, 56), (128, 28), (256, 14), (512, 7)])
    # print(c2wh[256])
    fca = MultiSpectralAttentionLayer(channel=30, dct_h=c2wh[512], dct_w=c2wh[512], reduction=16,
                                      freq_sel_method='top16')
    print(fca)
    output = fca(input)
    print(output.shape)

    # model = FcaBasicBlock(inplanes=30, planes=512, stride=1, downsample=None, groups=1,
    #                       base_width=64, dilation=1, norm_layer=None, reduction=16)
    # model.eval()
    # print(model)
    # # input = torch.randn(64, 30, 15, 15)
    # input = torch.randn(60, 30, 15, 15)
    # y = model(input)
    # print(y.size())
